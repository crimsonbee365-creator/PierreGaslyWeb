...
$stats = [
    'all' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews")['count'],
    '5' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews WHERE rating = 5")['count'],
    '4' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews WHERE rating = 4")['count'],
    '3' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews WHERE rating = 3")['count'],
    '2' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews WHERE rating = 2")['count'],
    '1' => $db->fetchOne("SELECT COUNT(*) as count FROM reviews WHERE rating = 1")['count'],
];

$avg_rating = $db->fetchOne("SELECT COALESCE(AVG(rating), 0) as avg FROM reviews")['avg'];
...
<div class="ratings-header-card">
    <div class="ratings-header-grid">
        <div class="avg-rating-display">
            <div class="avg-rating-number"><?php echo number_format($avg_rating, 1); ?></div>
            ...
            <div class="avg-rating-label">Based on <?php echo number_format($stats['all']); ?> reviews</div>
        </div>
