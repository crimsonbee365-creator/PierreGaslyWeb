            ...
            <div class="settings-card" style="margin-bottom: 25px;">
                ...
                <div class="settings-card-body">
                    <div class="database-actions">
                        ...
                        <p style="margin: 0 0 15px; font-size: 13px; color: #e65100;">
                            These actions affect your entire database. Use with caution.
                        </p>
                        <div class="database-actions-grid">
                            <button class="db-action-btn" onclick="showConfirmPopup('Database Backup', 'Create a backup of your entire database?', function() { window.location.href='?action=backup'; })">
                                💾 Backup Database
                            </button>
                            <button class="db-action-btn" onclick="showConfirmPopup('Export Data', 'Export all data to CSV format?', function() { window.location.href='?action=export'; })">
                                📤 Export Data (CSV)
                            </button>
                        </div>
                    </div>
